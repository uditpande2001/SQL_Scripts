...
LEFT join    
            ...
            RIGHT JOIN    
                        ...
                        FROM rf_diag rd WHERE server_time BETWEEN '2023-07-05 00:00:00.000' AND '2023-07-05 23:59:59.999'
                        AND node_id >=400000 
...
LEFT JOIN 
            ...
            WHERE server_time BETWEEN '2023-07-05 00:00:00.000' AND '2023-07-05 23:59:59.999'
            AND "type" = 'Instant_Profile'
            GROUP BY node_id) node_instant
ON mm.node_id = node_instant.node_id
ORDER BY node_instant.latest_instant_time desc;
