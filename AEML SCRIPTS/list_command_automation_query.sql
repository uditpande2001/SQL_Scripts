...
from meter_mapping mm
    left join (
        ...
        where "type" = 'Instant_Profile'
            and server_time between '2023-04-20 00:00:00.000' and '2023-04-20 23:59:59.999'
     ...
     left join (
        ...
        where "type" = 'Midnight_Profile'
            and server_time between '2023-04-19 22:00:00.000' and '2023-04-20 23:59:59.999' AND date_time = '2023-04-20 00:00:00.000'
        group by meter_number
    ...
    left join (
        ...
        from node_init ni
        where server_time between '2023-04-20 00:00:00.000' and '2023-04-20 23:59:59.999'
        group by meter_number
    	...
    	FROM (
		        ...
		        FROM (
					...
					FROM  
						...
						FROM  dcu_health dh
						WHERE health_time BETWEEN '2023-04-20 00:00:00.000' and '2023-04-20 23:59:59.999'
						GROUP BY hub_uuid
						) dcu_health_data
