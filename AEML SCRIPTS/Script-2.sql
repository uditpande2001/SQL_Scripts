...
LEFT join    
            ...
            RIGHT JOIN    
                        ...
                        FROM rf_diag rd WHERE server_time BETWEEN '2023-06-07 00:00:00.000' AND '2023-06-07 23:59:59.999'
                        AND node_id >=400000 
...
LEFT JOIN 
            ...
            WHERE server_time BETWEEN '2023-06-07 00:00:00.000' AND '2023-06-07 23:59:59.999'
