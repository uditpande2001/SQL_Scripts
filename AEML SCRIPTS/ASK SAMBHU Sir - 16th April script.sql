-- changes date time TO NOT NULL AND added distinct	
	
SELECT DISTINCT node_gw.gw_id, required_meters.node_id FROM
                        (
                            ...
                            RIGHT JOIN
                                (
                                    ...
                                    FROM rf_diag rd
                                    WHERE server_time >= '2023-04-16 06:00:00.000' AND node_id >= 400000
                                    GROUP BY node_id
                                ) diag_data
                        ...
                        RIGHT JOIN
                            (
                                ...
                                LEFT join
                                        ...
                                        WHERE "type" = 'Midnight_Profile' AND date_time = '2023-04-16 00:00:00.000'
                                            ) mid_data
                                            RIGHT JOIN
                                                    (
                                                        ...
                                                        and date_time = '2023-04-16 00:00:00.000'
                       ...
                       WHERE node_gw.gw_id IS NOT null ;
