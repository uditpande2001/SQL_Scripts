...
left join (
		...
		from
			(
				...
				server_time >= '2023-04-17 22:00:00' and server_time <= '2023-04-18 23:59:59'
				and date_time = '2023-04-18 00:00:00' 
...
left join (
		...
		from
			(
				...
				server_time >= '2023-04-17 00:00:00' and server_time <= '2023-04-17 23:59:59' 
		...
		right join 
			(	select meter_slot.meter_number, meter_slot.slot_count, meter_slot.last_time from 
					(	
						...
						server_time between '2023-04-17 00:00:00' and '2023-04-17 23:59:59'
						group by meter_number
					) meter_slot
			) required_mtr_slot
